...
export const mockProjects: ProjectResponse[] = [
    ...
    },
    {
        ...
        projectMembers: [
            ...
            { memberId: "10", memberName: "Anh.Nguyen", memberImage: "https://i.pravatar.cc/150?img=10" },
        ],
        totalTasks: 30,
...
export const mockTasks: TaskResponse[] = [
    ...
    },
    {
        ...
        taskCode: "TASK-003",
        description: "Create unit tests for all modules using Jest",
        assignees: [
            { memberId: "5", memberName: "HaTT.Nguyen", memberImage: "https://i.pravatar.cc/150?img=5" },
            { memberId: "6", memberName: "HaTT.Nguyen", memberImage: "https://i.pravatar.cc/150?img=6" },
        ],
        attachments: [],
...
export const mockComments: CommentResponse[] = [
    ...
    },
    {
        ...
        memberId: 2,
        memberName: "Duy.Le",
        description: "Need to review the color scheme",
